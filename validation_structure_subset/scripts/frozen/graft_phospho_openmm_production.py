...
def run_grafting(
    ...
    for model_index in selected_model_indices:
        ...
        # Sort sites N-to-C for deterministic context-aware scanning.
        ...
        for site in sites_sorted:
            ...
            try:
                ...
                if prescan_rotamer and relax_mode == "openmm_local":
                    ...
                    prescan_info["prescan_context"] = "sequential_grafted_model_premin"
    ...
    fieldnames = [
        ...
        "prescan_context", "applied_initial_rotations",
